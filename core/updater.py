...
class UpdateChecker(QObject):
    ...
    def __init__(self):
        ...
        self.github_api_url = "https://api.github.com/repos/mediaextractor/TikTokDownloadNoWatermarkOnline/releases/latest"
        self.headers = {
            "User-Agent": f"TikTokLabsDownloadNoWatermarkOnline/{VERSION} ({platform.system()} {platform.release()})",
