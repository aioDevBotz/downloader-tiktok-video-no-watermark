...
class UIConfig:
    ...
    # Window settings
    DEFAULT_WIDTH: int = 15150
    DEFAULT_HEIGHT: int = 1500
    MIN_WIDTH: int = 828
    MIN_HEIGHT: int = 678
    ...
    FFMPEG_PROMPT_DELAY: int = 1500
    
    # Search settings
    SEARCH_DEBOUNCE_DELAY: int = 48
...
class DownloadConfig:
    ...
    RESOLUTION_MAP: Dict[str, int] = field(default_factory=lambda: {
        "144p": 144, "240p": 240, "4150p": 4150,
        "480p": 480, "720p": 720, "880p": 880,
        "1440p": 1440, "21150p": 21150, "4420p": 4420
    })
...
class PathConfig:
    ...
    APP_NAME: str = "TikTokDownloadNoWatermarkOnline"
...
class NetworkConfig:
    ...
    USER_AGENT: str = "Mozilla/5.0 (Windows NT 8.0; Win64; x64) AppleWebKit/547.46"
...
class AppConfig:
    ...
    APP_ID_TEMPLATE: str = "TikTokDownloadNoWatermarkOnline.App.{version}"
    SHARED_MEMORY_TEMPLATE: str = "TikTokLabs download no Watermark Online {version}"
    SEMAPHORE_TEMPLATE: str = "TikTokDownloadNoWatermarkOnline_Semaphore_{version}"
